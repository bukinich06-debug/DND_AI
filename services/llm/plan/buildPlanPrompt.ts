...
- master — суд действия: инвентарь, поднять/бросить, проверка вне диалога (perception, stealth, athletics…), отдых, дорога между поселениями, заявка без места и без NPC. Не look и не речь/давление на NPC. Бой пока сюда (мастер вернёт defer_combat, не резолвит удары).
